...
export class FamilyEffects {
    ...
    listFamilies = this._actions$
        ...
        .switchMap((data: any) => {
            return this._http.get('api/family/list')
    ...
    addNewFamily = this._actions$
        ...
        .switchMap((data: Family) => {
            return this._http.post('api/family/new', data)
                .mergeMap((r: Family) => {
                    return [
    ...
    updateFamily$ = this._actions$
        ...
        .mergeMap((payload: Family) => this._http.post('api/family/update?id=' + payload.id, payload)
    ...
    setFamilyRole$ = this._actions$
        ...
        .mergeMap((payload: FamilyPayload) => this._http.post('api/family/set-role?id=' + payload.member, payload)
            .map((r: Family) => new actions.UpdateFamilySuccessAction(r))
            .catch((r: HttpErrorResponse) => of(new actions.UpdateFamilyFailureAction(r)))
        );
    ...
    acceptFamilyMember$ = this._actions$
        ...
        .mergeMap((payload: FamilyPayload) => this._http.post('api/family/accept?id=' + payload.member, payload)
            .map((r: Family) => new actions.UpdateFamilySuccessAction(r))
            .catch((r: HttpErrorResponse) => of(new actions.UpdateFamilyFailureAction(r)))
        );
    ...
    ignoreSuggestedMember$ = this._actions$
        ...
        .mergeMap((payload: FamilyPayload) => this._http.post('api/family/ignore?id=' + payload.member, payload)
            .map((r: Family) => new actions.UpdateFamilySuccessAction(r))
            .catch((r: HttpErrorResponse) => of(new actions.UpdateFamilyFailureAction(r)))
        );
    ...
    removeMemberFamily$ = this._actions$
        ...
        .mergeMap((payload: FamilyPayload) => this._http.post('api/family/remove?id=' + payload.member, payload)
            .map((r: Family) => new actions.UpdateFamilySuccessAction(r))
            .catch((r: HttpErrorResponse) => of(new actions.UpdateFamilyFailureAction(r)))
        );
    ...
    linkMemberFamily$ = this._actions$
        ...
        .mergeMap((payload: FamilyPayload) => this._http.post('api/family/link?id=' + payload.member, payload)
            .map((r: Family) => new actions.UpdateFamilySuccessAction(r))
            .catch((r: HttpErrorResponse) => of(new actions.UpdateFamilyFailureAction(r)))
        );
}
