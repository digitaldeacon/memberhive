...
export const getSelectedPerson: any = createSelector(
  getPersonState,
  person.person
);
export const getLastCreatedPersonId: any = createSelector(
  getPersonState,
  person.lastCreatedPersonId
);
/**
 * Auth Reducers
 */
...
export const isAuthLoading: any = createSelector(
  getAuthState,
  auth.isAuthenticationLoading
);
export const getAuthError: any = createSelector(
  getAuthState,
  auth.getAuthenticationError
);
export const isAuthLoaded: any = createSelector(
  getAuthState,
  auth.isAuthenticatedLoaded
);
export const getAuthPersonId: any = createSelector(
  getAuthState,
  auth.getPersonId
);
...
export const getLayoutSettings: any = createSelector(
  getSettingsState,
  settings.layoutSettings
);
export const getPeopleSettings: any = createSelector(
  getSettingsState,
  settings.peopleSettings
);
export const getPeopleListSettings: any = createSelector(
  getSettingsState,
  settings.peopleListSettings
);
export const getPeopleFilterSettings: any = createSelector(
  getSettingsState,
  settings.peopleFilterSettings
);
export const getProfileSettings: any = createSelector(
  getSettingsState,
  settings.profileSettings
);
export const getSysSettings: any = createSelector(
  getSettingsState,
...
export const getContextButtons: any = createSelector(
  getSettingsState,
  settings.contextButtons
);
export const getSysGoogleKey: any = createSelector(
  getSettingsState,
...
export const getInteractions: any = createSelector(
  getInteractionState,
...
export const getFamilyPerson: any = createSelector(
  getFamilies,
  getSelectedPerson,
  (families: any, p: any) => {
    return "id" in p.family
      ? families.filter((f: any) => f.id === p.family.id)
      : [];
  }
);
/**
 * Loading  Reducers
 */
export const getLoadingP: any = createSelector(
  getPersonState,
  person.loadingPerson
);
export const getLoadingS: any = createSelector(
  getSettingsState,
  settings.loadingSettings
);
export const getLoadingI: any = createSelector(
  getInteractions,
  interaction.loadingInteraction
);
 ...
 * Message  Reducers
 */
export const getMessageP: any = createSelector(
  getPersonState,
...
export const getMessageI: any = createSelector(
  getInteractionState,
  interaction.messageInteraction
);
export const getMessageT: any = createSelector(getTagState, tags.messageTags);
export const getMessageF: any = createSelector(
  getFamilyState,
...
export const getMessage: any = createSelector(
  ...
  getMessageT,
  getMessageF,
  (msgP: any, msgS: any, msgI: any, msgT: any, msgF: any) =>
    msgP || msgS || msgI || msgT || msgF
);
    ...
    function search(prs: person.Person) {
      return this.every((searchTerm: string) => {
        ...
        if (fieldSearch.length === 1) {
          ...
          const sStatus = prs.status.some((s: tags.Tag) =>
            s.text.includes(searchTerm)
          );
          found = sFullname || sStatus;
        } else {
          const filterSet: FilterSet = person.personFilterSet.filter(
            (set: any) => set.label === fieldSearch[0].toLocaleLowerCase()
          )[0];
          if (filterSet.key === "age") {
            ...
            if (exprRange.length > 1) {
              found =
                prs[filterSet.key] >= parseInt(exprRange[0], 10) &&
