...
export class InteractionEffects {
  ...
  getInteractions$ = this._actions$
    ...
    .switchMap((data: InteractionPayload) => {
      return (
        this._http
          .get("interaction/list?") // + data.id
          // + '&noMarkup=' + data.noMarkup + '&me=' + data.me)
          .map(
            (r: Interaction[]) => new actions.ListInteractionsSuccessAction(r)
          )
          .catch((r: HttpResponse<any>) =>
            of(new actions.ListInteractionsFailureAction(r))
          )
      );
    });
  ...
  addInteraction$ = this._actions$
    ...
    .switchMap((data: Interaction) =>
      this._http
        ...
        .catch((r: HttpResponse<any>) =>
          of(new actions.AddInteractionFailureAction(r))
        )
    );
  ...
  updateInteraction$ = this._actions$
    ...
    .switchMap((data: Interaction) =>
      this._http
        ...
        .catch((r: HttpResponse<any>) =>
          of(new actions.UpdateInteractionFailureAction(r))
        )
    );
  ...
  deleteInteraction$ = this._actions$
    ...
    .switchMap((interactionId: number) =>
      this._http
        ...
        .catch((r: HttpResponse<any>) =>
          of(new actions.DeleteInteractionFailureAction(r))
        )
    );
